"""How hard does the router go indoors and upstairs, and what does that buy?
    ...
    python tools/bench_indoor.py                      # door-penalty sweep, 14:00
    python tools/bench_indoor.py --sweep rise,door,K  # all three, ONE weather payload
    python tools/bench_indoor.py --sweep K --hour 9 --n 60
    python tools/bench_indoor.py --key protected      # the other keying arm
...
from shademe.api.cost import thermal_summary, protected, utci_cost, door_state
from shademe.api.routing import shortest, path_length, _astar_state
