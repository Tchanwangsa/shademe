"""What the benefit looks like hour by hour, in both of the units the UI could show.
    ...
    python scripts/bench_hours.py                 # summer, 40 pairs, hours 07..20
    python scripts/bench_hours.py --mode winter
    python scripts/bench_hours.py --shade-only    # indoor routing off (door = inf)
...
scripts/bench_indoor.py for why that matters.
"""
...
from server.cost import thermal_summary, compare_thermal
from server.routing import shortest, path_length
