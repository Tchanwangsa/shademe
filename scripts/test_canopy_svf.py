"""Checks for the analytic canopy sky-blocking. Run: python scripts/test_canopy_svf.py
...
from canopy_svf import blocking, Z_PED, TAU_LEAF
...
if not all(os.path.exists(p) for p in need):
    print("  (svf rasters not built; run scripts/svf.py then scripts/canopy_svf.py)")
else:
