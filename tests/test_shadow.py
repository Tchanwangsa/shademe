"""Checks for the crown-slab shadow path. Run: python tests/test_shadow.py
...
from shademe.physics.shadow import (sun_position, shadow_mask, canopy_mask,
                                    shade_factor, point_shade)
