...
free parameters. Heights are joined to the canopy polygons by STRtree.
    ...
    python -m shademe.pipeline.tree_heights
"""
...
from ..config import BBOX, WGS84, MGA55, COM
...
# a (m, fixed asymptote), b, c -- R2/RMSE per class in the header comment above
CLASS_COEF = {
    #                     a      b        c       n     R2     RMSE
...
# canopy. shademe/physics/shadow.py needs the bottom of that crown, not just its top, or every
